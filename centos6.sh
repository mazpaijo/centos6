...
sed -i '$ i\screen -AmdS user-limit /root/user-limit.sh --listen-addr 127.0.0.1:7300' /etc/rc.local
sed -i '$ i\screen -AmdS user-limit /root/user-limit.sh --listen-addr 127.0.0.1:7300' /etc/rc.d/rc.local
