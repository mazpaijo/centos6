...
# set repo
wget -O /etc/apt/sources.list "https://raw.github.com/mazpaijo/centos6/master/conf/sources.list.debian7"
...
echo "<pre>ini home biasa kox</pre>" > /home/vps/public_html/index.html
...
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.github.com/mazpaijo/centos6/master/conf/1194.conf"
...
curl "https://raw.github.com/mazpaijo/centos6/master/conf/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid/squid.conf "https://raw.github.com/mazpaijo/centos6/master/conf/squid.conf"
